...
openai.api_key = "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"
...
# c.execute('''CREATE TABLE RESPONSES ([generated_id] INTEGER PRIMARY KEY, [Entry] text, [Response] text) ''')
...
#method called when the text is submitted
